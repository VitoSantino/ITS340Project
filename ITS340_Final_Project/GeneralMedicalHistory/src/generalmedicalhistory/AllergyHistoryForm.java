...
public class AllergyHistoryForm extends JFrame {
    ...
    private JButton generalMedicalHistory;
    ...
    private void initComponents(){
        generalMedicalHistory = new javax.swing.JButton();
        ...
        generalMedicalHistory.setText("Back to Interview Form");
        generalMedicalHistory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                generalMedicalHistoryActionPerformed(evt);
        }
    });
        ...
        buttonPanel.add(generalMedicalHistory);
    ...
    private void saveButtonClicked(){
         String dbUrl = "jdbc:mysql://localhost:3306/genmedhx2?autoReconnect=true&useSSL=false";
          String query = "insert into patient "
                     + "(LastName, FirstName, Date of Birth, Gender, Mobile Phone, Address, City, State, Zip Code, Notes)"
                     + " values ('Doe', 'John', '01-01-2000', 'Male', '219-123-4567', '123 Main Street', 'Anytown', 'Indiana', '46322', 'Good Health')";
    ...
    private void generalMedicalHistoryActionPerformed(java.awt.event.ActionEvent evt){
        this.setVisible(false);
        new InterviewForGeneralMedicalHistory().setVisible(true);
    }
    ...
    public static void main(String[] args){
        ...
        String dbUrl = "jdbc:mysql://localhost:3306/genmedhx?autoReconnect=true&useSSL=false";
    }
}
